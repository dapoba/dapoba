...
{ 
	...
	String sql = ""; // SQL 작성
		...
		sql="update dapoba_db.cabinet set cabinet_password='0', cabinet_state='0' where (cabinet_number = '"+cabinet_num+"') and (cabinet_loc ='"+loc+"'); ";
		stmt.execute(sql);
		out.print("<h6 class=\"margin-bottom\">사물함을 비웠습니다.</h6><br>");
