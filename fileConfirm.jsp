    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-2">
          <h4 class="margin-option">파일업로드가 완료되었습니다.</h4>
        <button type="button" > <a href="file.jsp">문서함으로 </a></button> 
          <button type="button" ><a href="main.html">홈으로 </a></button>
        </div>
      </div>
    </div> <!-- /container -->
</body>
